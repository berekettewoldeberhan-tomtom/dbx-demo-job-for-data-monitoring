...
logger = log4j_logger.LogManager.getLogger('dbx-demo_logger')

logger.info("dbx-demo job started  ... (sample Python job prepared for Azure monitor)")
...
logger.info("dbx-demo job completed  ... (sample Python job prepared for Azure monitor)")
